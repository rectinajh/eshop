...
<head>
<meta charset="UTF-8" />
<title><?php echo $Title; ?> - <?php echo $Powered; ?> - www.ohbbs.cn 欧皇源码论坛 </title>
      ...
      <div class="server">
        <table width="100%">
          ...
          <tr>
            ...
            <td><input type="text" name="dbname" id="dbname" value="goldchain" class="input" onBlur="TestDbPwd(0)"></td>
