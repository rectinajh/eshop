 ...
 * 掌上如意商城 支付宝插件
 * ============================================================================
 * 版权所有 2015-2027 掌上如意商城有限公司，并保留所有权利。
 * 网站地址: http://
 * ----------------------------------------------------------------------------
...
{    
    ...
    {         
            ...
            $parameter = array(
                        ...
                        "subject"       =>"新淘商城订单", //订单名称，必填
                        "total_fee"	=> $order['order_amount'], //付款金额
                        "show_url"	=> "https://www.58xintao.com", //收银台页面上，商品展示的超链接，必填
            ...
            error_log(date('Y-m-d H:i:s'). var_export($parameter , true). "\n", 3, __DIR__ . '/alipay.log');
            //建立请求
    ...
    function response()
    {
        ...
        $verify_result = $alipayNotify->verifyNotify();
            error_log(date('Y-m-d H:i:s').var_export($verify_result, true), 3, __DIR__ . '/alipay.log');
