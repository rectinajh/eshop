<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:45:"./application/admin/view2/recognize/plan.html";i:1532661068;s:44:"./application/admin/view2/public/layout.html";i:1532661068;}*/ ?>
<!doctype html>
<html>
<head>
		...
		<div class="mDiv">
			...
			<div class="tDiv2">
				<div class="fbutton" style="top: -6px;position: relative;">
					<a href="<?php echo url('Recognize/planAdd'); ?>">
			...
			<form class="navbar-form form-inline" id="search-form" action="<?php echo url('Recognize/plan'); ?>" method="get" onsubmit="return check_form();">
				<div class="sDiv">
				...
				<table>
					...
					<?php if(is_array($lists) || $lists instanceof \think\Collection || $lists instanceof \think\Paginator): if( count($lists)==0 ) : echo "" ;else: foreach($lists as $k=>$vo): ?>
						<tr>
							...
							<td align="left" class="">
								<div style="text-align: left; width: 160px;"><?php echo $vo['plan_no']; ?></div>
							</td>
							<td align="left" class="">
								<div style="text-align: left; width: 120px;"><?php echo $vo['title']; ?></div>
							</td>
							<td align="left" class="">
								<div style="text-align: right; width: 80px;"><?php echo $vo['price']; ?></div>
							</td>
							<td align="left" class="">
								<div style="text-align: right; width: 80px;"><?php echo $vo['total_qty']; ?></div>
							</td>
							<td align="left" class="">
								<div style="text-align: right; width: 80px;"><?php echo $vo['limit_qty']; ?></div>
							</td>
							<td align="left" class="">
								<div style="text-align: right; width: 80px;"><?php echo $vo['sold_qty']; ?></div>
							</td>
							<td align="left" class="">
								<div style="text-align: right; width: 80px;"><?php echo $vo['remain_qty']; ?></div>
							</td>
							<td align="center" class="">
								<div style="text-align: center; width: 80px;"><?php echo $vo['status_text']; ?></div>
							</td>
							<td align="left" class="">
							...
							<td align="left" class="handle">
								<div style="text-align: left; width: 170px; max-width:170px;">
									<a class="btn blue" href="<?php echo url('Recognize/planEdit', array('id' => $vo['id'])); ?>"><i class="fa fa-edit"></i>编辑</a>
									<a class="btn red" href="<?php echo url('Recognize/trade', array('id' => $vo['id'])); ?>"><i class="fa fa-send"></i>交易详情</a>
								</div>
							</td>
