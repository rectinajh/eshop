<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:39:"./application/seller/new/admin/log.html";i:1532228866;s:41:"./application/seller/new/public/head.html";i:1532228866;s:41:"./application/seller/new/public/left.html";i:1532228866;s:41:"./application/seller/new/public/foot.html";i:1532228866;}*/ ?>
<!doctype html>
   ...
   <div id="sidebar" class="sidebar">
	...
	<div id="layoutRight" class="ncsc-layout-right">
		...
		<div class="main-content" id="mainContent">
			<div class="tabmenu">
				<ul class="tab pngFix">
					<li class="active"><a href="<?php echo U('seller/Admin/log'); ?>">日志列表</a></li>
				</ul>
			</div>
			<table class="ncsc-default-table">
				...
				<?php if(empty($list) || (($list instanceof \think\Collection || $list instanceof \think\Paginator ) && $list->isEmpty())): ?>
					...
					<tr class="bd-line">
						<td class="trigger"><?php echo $vo['log_id']; ?></td>
						<td class="tl"><span><?php echo $vo['log_seller_name']; ?></span></td>
						<td class="tl"><span><?php echo $vo['log_content']; ?></span></td>
						<td class=""><span><?php echo $vo['log_seller_ip']; ?></span></td>
						<td class=""><span><?php echo date("Y-m-d H:i:s",$vo['log_time']); ?></span></td>
					</tr>
