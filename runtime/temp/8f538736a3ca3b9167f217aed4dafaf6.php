<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:45:"./application/admin/view2/user/ajaxindex.html";i:1532661069;}*/ ?>
        ...
        <?php if(is_array($userList) || $userList instanceof \think\Collection || $userList instanceof \think\Paginator): $i = 0; $__LIST__ = $userList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
            <tr data-id="<?php echo $list['user_id']; ?>">
                ...
                <td align="left" class="">
                    ...
                    <div style="text-align: center; width: 50px;"><?php echo $list['levelname']; ?></div>
                </td>
                <td align="left" class="">
                    <div style="text-align: center; width: 60px;"><?php echo $list['total_amount']; ?></div>
                </td>
                <td align="left" class="">
                    <div style="text-align: center; width: 60px;"><?php echo $list['team_performance']; ?></div>
                </td>
                <td align="left" class="">
                ...
                <td align="left" class="">
                    <div style="text-align: center; width: 50px;"><?php echo $list['user_money']; ?></div>
                </td>
               <!--  <td align="left" class="">
                    <div style="text-align: center; width: 50px;"><?php echo $list['pay_points']; ?></div>
                </td> -->
                <td align="left" class="">
                    <div style="text-align: center; width: 50px;"><?php echo $list['withdraw_money']; ?></div>
                </td>
                <td align="left" class="">
                    <div style="text-align: center; width: 50px;"><?php echo $list['jin_num']; ?></div>
                </td>
                <td align="left" class="">
                    <div style="text-align: center; width: 50px;"><?php echo $list['dedication_money']; ?></div>
                </td>
                <td align="left" class="">
                    <div style="text-align: center; width: 50px;"><?php echo $list['consume_cp']; ?></div>
                </td>
                <td align="left" class="">
                ...
                <td align="center" class="handle">
                    <div style="text-align: center; width: 170px; max-width:170px;">
                        ...
                        <a class="btn red"  href="javascript:void(0)" data-url="<?php echo U('Admin/user/ajax_delete'); ?>" data-id="<?php echo $list['user_id']; ?>" onClick="delfun(this)"><i class="fa fa-trash-o"></i>删除</a>
                    </div>
                </td>
