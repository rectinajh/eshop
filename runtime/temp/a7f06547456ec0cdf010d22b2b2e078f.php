<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:49:"./application/seller/new/goods/ajaxGoodsList.html";i:1532661068;}*/ ?>
<table class="ncsc-default-table">
    ...
    <?php else: if(is_array($goodsList) || $goodsList instanceof \think\Collection || $goodsList instanceof \think\Paginator): $i = 0; $__LIST__ = $goodsList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
        <tr class="bd-line">
            ...
            <td><img width="20" height="20" src="__PUBLIC__/images/yes.png" onclick="changeTableVal2('goods','goods_id','<?php echo $list['goods_id']; ?>','is_on_sale',this);changeTableVal2('goods','goods_id','<?php echo $list['goods_id']; ?>','goods_state',this);$(this).parent().parent().remove();"/></td>
