<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:40:"./application/seller/new/admin/role.html";i:1532228866;s:41:"./application/seller/new/public/head.html";i:1532228866;s:41:"./application/seller/new/public/left.html";i:1532228866;s:41:"./application/seller/new/public/foot.html";i:1532228866;}*/ ?>
<!doctype html>
   ...
   <div id="sidebar" class="sidebar">
	...
	<div id="layoutRight" class="ncsc-layout-right">
		...
		<div class="main-content" id="mainContent">
			<div class="tabmenu">
				<ul class="tab pngFix">
					<li class="active"><a href="<?php echo U('seller/Admin/role'); ?>">角色列表</a></li>
				</ul>
				<a href="<?php echo U('Admin/role_info'); ?>" class="ncbtn ncbtn-mint" title="添加角色">添加角色</a>
			</div>
			<table class="ncsc-default-table">
				...
				<?php if(empty($list) || (($list instanceof \think\Collection || $list instanceof \think\Paginator ) && $list->isEmpty())): ?>
					...
					<tr class="bd-line">
						<td class="trigger"><?php echo $vo['group_id']; ?></td>
						<td class="tl"><span><?php echo $vo['group_name']; ?></span></td>
						<td class="nscs-table-handle">
                            <span>
                                <a href="<?php echo U('Admin/role_info',array('group_id'=>$vo['group_id'])); ?>" class="btn-bluejeans"><i class="icon-edit"></i><p>编辑</p></a>
                            </span>
							<span>
								<a href="javascript:void(0);" data-url="<?php echo U('Admin/roleDel'); ?>" data-id="<?php echo $vo['group_id']; ?>" onclick="delfun(this)" class="btn-grapefruit"><i class="icon-trash"></i><p>删除</p></a>
							</span>
						</td>
					</tr>
