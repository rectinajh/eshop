<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:43:"./application/admin/view2/plugin/index.html";i:1532661069;s:44:"./application/admin/view2/public/layout.html";i:1532661069;}*/ ?>
<!doctype html>
<html>
<head>
                            ...
                            <td align="center" class="handle">
                                ...
                                <div style="text-align: center; width: 170px; max-width:170px;">
                                    ...
                                    <?php if($l['status'] == 0): ?>
                                        ...
                                        <a data-shipping-code="<?php echo $l[code]; ?>" class="btn red delShipping"><i class="fa fa-trash-o"></i>删除</a>
...
<script>
    ...
    $(function(){
        ...
        $(document).on('click','.delShipping',function(){
