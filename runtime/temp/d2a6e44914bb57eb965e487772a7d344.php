<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:42:"./application/seller/new/order/detail.html";i:1532661069;s:41:"./application/seller/new/public/head.html";i:1532661069;s:41:"./application/seller/new/public/left.html";i:1532661069;s:41:"./application/seller/new/public/foot.html";i:1532661069;}*/ ?>
<!doctype html>
  ...
  <div class="ncsc-order-info" style="margin-top:30px">
    ...
    <div class="ncsc-order-condition">
      <dl>
        ...
        <dd><?php echo $order_status_detail; ?></dd>
      </dl>
      <ul>
        <?php if($order[order_status] == 0): ?>
        	<li>该订单还未确认</li>
        <?php elseif($order[order_status] == 1 and $show_status < 3): ?>
        	<li>订单已经确认</li>
        <?php elseif($show_status == 3): ?>
            <li>订单已发货</li>
	    ...
	    <table class="ncsc-default-table order">
	      <thead>
	        ...
	        <tr>
	         ...
	         <tr class="bd-line">
	          <td class="w100"><?php echo $log['action_user']; ?></td>
