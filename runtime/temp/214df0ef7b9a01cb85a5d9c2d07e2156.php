<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:52:"./application/admin/view2/system/navigationList.html";i:1532661068;s:44:"./application/admin/view2/public/layout.html";i:1532661068;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
    ...
    <div id="explanation" class="explanation" style="color: rgb(44, 188, 163); background-color: rgb(237, 251, 248); width: 99%; height: 100%;">
        ...
        <ul>
            <li>前台导航列表, 由总平台设置管理.</li>
            <li>如果对前台导航进行了编辑更新，而前台页面没有变化，那么请先清除缓存.</li>
        </ul>
    </div>
    <div class="flexigrid">
        <div class="mDiv">
                        ...
                        <tr>
                            ...
                            <td class="sort">
                                <div style="text-align: center; width: 150px;">
                                    <input title="鼠标移开将自动保存, 数值越大越靠前" style="text-align: center;" type="text" onKeyUp="this.value=this.value.replace(/[^\d]/g,'')" onpaste="this.value=this.value.replace(/[^\d]/g,'')" onblur="changeTableVal('navigation','id','<?php echo $vo['id']; ?>','sort',this)"  size="4"  value="<?php echo $vo['sort']; ?>" />
                                </div>
                            </td>
                            <td align="center" class="handle">
                                <div style="text-align: center; width: 170px; max-width:170px;">
                                    ...
                                    <?php endif; ?>
                                    <a class="btn red" data-url="<?php echo U('System/ajax_delNav'); ?>" data-id="<?php echo $vo['id']; ?>" onClick="delfun(this)"><i class="fa fa-trash-o"></i>删除</a>
