<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:50:"./application/seller/new/finance/_withdrawals.html";i:1532228866;s:41:"./application/seller/new/public/head.html";i:1532228866;s:41:"./application/seller/new/public/left.html";i:1532228866;s:41:"./application/seller/new/public/foot.html";i:1532228866;}*/ ?>
<!doctype html>
                    ...
                    <div class="ncsc-form-goods">
                        <h3 id="demo1">提现申请</h3>
                            <dl>
                                <dt>提现金额：</dt>
                                <dd>
                                    <input type="text" onkeyup="this.value=this.value.replace(/[^\d.]/g,'')" onpaste="this.value=this.value.replace(/[^\d.]/g,'')" placeholder="最少提现额度<?php echo $withdrawals_min; ?>" name="money" id="money" value="<?php echo $withdrawals['money']; ?>" class="text w400">
                                </dd>
                            </dl>
                            <dl>
                                <dt>银行名称：</dt>
                                <dd>
                                    <input type="text" placeholder="如:支付宝,农业银行,工商银行等..." name="bank_name" id="bank_name" value="<?php echo $withdrawals['bank_name']; ?>" class="text w400">
                                </dd>
                            </dl>
                            <dl>
                                <dt>收款账号：</dt>
                                <dd>
                                    <input type="text" placeholder="如:支付宝账号,建设银行账号" name="bank_card" id="bank_card" value="<?php echo $withdrawals['bank_card']; ?>" class="text w400">
                                </dd>
                            </dl>
                            <dl>
                                <dt> 开户名：</dt>
                                <dd>
                                    <input type="text" placeholder="开户人姓名" name="realname" id="realname" value="<?php echo $withdrawals['realname']; ?>" class="text w400">
                                </dd>
                            </dl>
                    </div>
