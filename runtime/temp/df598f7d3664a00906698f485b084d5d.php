<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:49:"./application/seller/new/order/delivery_list.html";i:1532228866;s:41:"./application/seller/new/public/head.html";i:1532228866;s:41:"./application/seller/new/public/left.html";i:1532228866;s:41:"./application/seller/new/public/foot.html";i:1532228866;}*/ ?>
<!doctype html>
...
<div class="tabmenu">
  <ul id="tab" class="tab pngFix">
  	<li class="<?php if(\think\Request::instance()->param('shipping_status') == 0): ?>active<?php endif; ?>" data-val="0"><a  href="#">待发货</a></li>
  	<li class="normal  <?php if(\think\Request::instance()->param('shipping_status') == 2): ?>active<?php endif; ?>" data-val="2"><a  href="#">部分发货</a></li>
  	<li class="normal <?php if(\think\Request::instance()->param('shipping_status') == 1): ?>active<?php endif; ?>" data-val="1"><a  href="#">已发货</a></li>
  	<li class="normal" ><a href="<?php echo U('Service/return_list'); ?>">已退换货</a>
  </ul>
  </div>
...
<form method="post" action="<?php echo U('Order/ajaxdelivery'); ?>" id="search-form2" onsubmit="return false">
  ...
  <table class="search-form">
    <tr>
      ...
      <th>下单时间</th>
      <td class="w340">
	      <input type="text" class="text w120" name="add_time_begin" id="add_time_begin" placeholder="开始时间" value="<?php echo $begin; ?>"/>&nbsp;&#8211;&nbsp;
	      <input type="text" class="text w120" name="add_time_end" id="add_time_end" placeholder="结束时间" value="<?php echo $end; ?>"/>
	   </td>
