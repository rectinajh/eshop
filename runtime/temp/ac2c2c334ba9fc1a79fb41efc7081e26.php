<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:55:"./application/admin/view2/promotion/group_buy_list.html";i:1532661068;s:44:"./application/admin/view2/public/layout.html";i:1532661068;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
	...
	<div class="flexigrid">
		<div class="mDiv">
			...
			<form class="navbar-form form-inline" id="search-form" action="<?php echo U('Promotion/group_buy_list'); ?>" method="get" onsubmit="return check_form();">
					...
					<div class="sDiv2">
						<select name="status" class="select">
							...
							<?php if(is_array($state) || $state instanceof \think\Collection || $state instanceof \think\Paginator): if( count($state)==0 ) : echo "" ;else: foreach($state as $key=>$st): ?>
								<option value="<?php echo $key; ?>" <?php if($_POST[status] === $key.''): ?>selected<?php endif; ?>><?php echo $st; ?></option>
				...
				<table>
					...
					<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $k=>$vo): ?>
						<tr>
							...
							<td align="left" class="">
								<div style="text-align: center; width: 80px;"><?php echo $vo['start_time']; ?></div>
							</td>
							<td align="left" class="">
								<div style="text-align: center; width: 80px;"><?php echo $vo['end_time']; ?></div>
							</td>
							<td align="left" class="">
							...
							<td align="left" class="">
								<div style="text-align: center; width: 80px;"><?php echo $state[$vo[status]]; ?></div>
							</td>
							<td align="center" class="">
								<div style="text-align: center; width: 80px;">
									<?php if($vo[recommend] == 1): ?>
										<span class="yes" onClick="changeTableVal('group_buy','id','<?php echo $vo['id']; ?>','recommend',this)" ><i class="fa fa-check-circle"></i>是</span>
										<?php else: ?>
										<span class="no" onClick="changeTableVal('group_buy','id','<?php echo $vo['id']; ?>','recommend',this)" ><i class="fa fa-ban"></i>否</span>
									<?php endif; ?>
								</div>
							</td>
							<td align="left" class="handle">
								<div style="text-align: left; width: 170px; max-width:170px;">
									<?php if($vo['status'] == 0): ?>
										<a class="btn blue" onclick="changeStatus(1,'<?php echo $vo['id']; ?>','group_buy',2)"><i class="fa fa-check"></i>通过</a>
										<a class="btn red" onclick="changeStatus(2,'<?php echo $vo['id']; ?>','group_buy',2)"><i class="fa fa-ban"></i>拒绝</a>
									<?php endif; if($vo['status'] == 1): ?>
										<a class="btn red" onclick="changeStatus(3,'<?php echo $vo['id']; ?>','group_buy',2)"><i class="fa fa-close"></i>取消</a>
									<?php endif; ?>
