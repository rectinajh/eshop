<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:44:"./application/admin/view2/user/recharge.html";i:1532661069;s:44:"./application/admin/view2/public/layout.html";i:1532661069;}*/ ?>
<!doctype html>
<html>
<head>
                ...
                <table cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <th align="center" abbr="article_time" axis="col6" class="">
                            <div style="text-align: center; width: 50px;" class="">充值资金</div>
                        </th>
                        <th align="center" abbr="article_time" axis="col6" class="">
                        ...
                        <th align="center" abbr="article_time" axis="col6" class="">
                            <div style="text-align: center; width: 180px;" class="">交易流水号</div>
                        </th>
                ...
                <table>
                    ...
                    <?php if(is_array($lists) || $lists instanceof \think\Collection || $lists instanceof \think\Paginator): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
                        <tr>
                            ...
                            <td align="center" class="">
                                <div style="text-align: center; width: 50px;"><?php echo $list['account']; ?></div>
                            </td>
                            <td align="center" class="">
                            ...
                            <td align="center" class="">
                           	...
                           	<td align="center" class="">
                                <div style="text-align: center; width: 180px;"><?php echo (isset($list['transaction_id']) && ($list['transaction_id'] !== '')?$list['transaction_id']:'--'); ?></div>
                            </td>
