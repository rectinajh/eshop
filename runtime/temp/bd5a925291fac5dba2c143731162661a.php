<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:45:"./application/seller/new/order/editprice.html";i:1531973016;s:41:"./application/seller/new/public/head.html";i:1531973016;s:41:"./application/seller/new/public/left.html";i:1531973016;s:41:"./application/seller/new/public/foot.html";i:1531973016;}*/ ?>
<!doctype html>
    ...
    <div id="layoutRight" class="ncsc-layout-right">
        ...
        <div class="main-content" id="mainContent">
            <div class="item-publish">
                <form action="<?php echo U('Order/editprice',array('order_id'=>$order['order_id'])); ?>" method="post" id="edit_price">
                    <div class="ncsc-form-goods active" id="tab_tongyong">
                        ...
                        <dl>
                            <dt>物流运费：</dt>
                            <dd>
                            	<input type="text" class="text" id="shipping_price" name="shipping_price" value="<?php echo $order['shipping_price']; ?>" onkeyup="this.value=this.value.replace(/[^\d.]/g,'')" onpaste="this.value=this.value.replace(/[^\d.]/g,'')">
                            </dd>
                        </dl>
                        <dl>
                            <dt>订单价格微调：</dt>
                            <dd>
                            	  <input type="text" value="<?php echo $order['discount']; ?>" id="discount" name="discount" onkeyup="this.value=this.value.replace(/[^-?\d.]/g,'')" onpaste="this.value=this.value.replace(/[^-?\d.]/g,'')" class="text">
                            	  <p class="hint">请直接输入要调整的金额, 如果是正数价格下调, 负数价格上调</p>
                            </dd>
                        </dl>
                        <dl>
                            <dt>订单总金额：</dt>
                    ...
                    <div class="bottom tc hr32">
                        ...
                        <label class="submit-border">
                            <input nctype="formSubmit" class="submit" style="min-width:70px; width:70px" value="保存" type="submit">
                        </label>
                    </div>
                </form>
            </div>
...
$(document).ready(function(){
	...
	$("#edit_price").validate({
        ...
        messages:{
       		shipping_price:{
        		required:"请输入运费, 如果免邮请填写'0'"
        	},
        	discount:{
        		required:"请填写微调价格, 如果无需修改价格,请填写'0'"
        	}
        }
	});
