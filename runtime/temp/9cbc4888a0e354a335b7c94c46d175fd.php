<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:42:"./application/admin/view2/index/index.html";i:1532661069;s:45:"./application/admin/view2/public/menubox.html";i:1532661069;s:42:"./application/admin/view2/public/left.html";i:1532661069;}*/ ?>
<!doctype html>
...
<title>新淘链商城后台 - www.ohbbs.cn 欧皇源码论坛 </title>
  ...
  <div class="admincp-header-r">
    ...
    <div class="manager">
      ...
      <dl>
        ...
        <!-- <dt class="name">TPshop2.0公测版</dt>

        <dd class="group">ThinkPHP5框架测试版</dd>
 -->
      </dl>    
    ...
    <ul class="operate nc-row">
      ...
      <!-- li tptype="pending_matters"><a class="toast show-option" href="javascript:void(0);" onClick="$.cookie('commonPendingMatters', 0, {expires : -1});ajax_form('pending_matters', '待处理事项', 'http://www.tpshop.cn/admin/index.php?act=common&op=pending_matters', '480');" title="查看待处理事项">&nbsp;<em>0</em></a></li-->
