<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:50:"./application/admin/view2/finance/withdrawals.html";i:1532661069;s:44:"./application/admin/view2/public/layout.html";i:1532661069;}*/ ?>
<!doctype html>
<html>
<head>
            ...
            <div class="hDivBox">
                <table cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <th align="center" abbr="article_time" axis="col6" class="">
                            <div style="text-align: center; width: 100px;" class="">实际到账</div>
                        </th>
                        <th align="center" abbr="article_time" axis="col6" class="">
                ...
                <table>
					...
					<?php else: if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                        <tr>
                            ...
                            <td align="center" class="">
                                <div style="text-align: center; width: 100px;"><?php echo $v['shen_money']; ?></div>
                            </td>
                            <td align="center" class="">
                                    <div style="text-align: center; width: 100px;"><?php echo $v['fee']; ?></div>
                            </td>
                            <td align="center" class="">
                            ...
                            <td align="center" class="">
                                <div style="text-align: center; width: 100px;">
                                    <?php if($v[status] == 0): ?>待审核<?php endif; if($v[status] == 1): ?>审核通过<?php endif; if($v[status] == -1): ?>审核失败<?php endif; if($v[status] == -2): ?>无效作废<?php endif; ?>
                                </div>
                            </td>
