<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:49:"./application/seller/new/promotion/group_buy.html";i:1532661068;s:41:"./application/seller/new/public/head.html";i:1532661068;s:41:"./application/seller/new/public/left.html";i:1532661068;s:41:"./application/seller/new/public/foot.html";i:1532661068;}*/ ?>
<!doctype html>
   ...
   <div id="sidebar" class="sidebar">
    ...
    <div id="layoutRight" class="ncsc-layout-right">
        ...
        <div class="main-content" id="mainContent">
            <div class="tabmenu">
                <ul class="tab pngFix">
                    <li class="normal"><a href="<?php echo U('Promotion/group_buy_list'); ?>">团购列表</a></li>
                    <li class="active"><a href="<?php echo U('Promotion/group_buy'); ?>">新增/编辑团购</a></li>
                </ul>
            </div>
            <div class="ncsc-form-default">
                <form id="handleposition" method="post" onsubmit="return false;">
                            ...
                            <div style="overflow: hidden" id="selected_group_goods">
                                <?php if($info['goods_id'] > 0): ?>
                                    <div style="float: left;margin-right: 10px" class="selected-group-goods">
                                        <div class="goods-thumb"><img <?php if(!(empty($info['specGoodsPrice']) || (($info['specGoodsPrice'] instanceof \think\Collection || $info['specGoodsPrice'] instanceof \think\Paginator ) && $info['specGoodsPrice']->isEmpty()))): ?>src="info['specGoodsPrice']['spec_img']"<?php else: ?>src="<?php echo goods_thum_images($info['goods_id'],162,162); ?>"<?php endif; ?></notempty>/></div>
                                        <div class="goods-name">
                                            <a id="group_buy_goods_name" href="<?php echo U('Home/Goods/goodsInfo',array('id'=>$info['goods_id'])); ?>" target="_blank"><?php echo $info['goods_name']; ?></a>
                                        </div>
                    ...
                    <dl>
                        <dt>虚拟购买数：</dt>
                        <dd>
                            <input class="w70 text" name="virtual_num" value="<?php echo $info['virtual_num']; ?>"  onpaste="this.value=this.value.replace(/[^\d]/g,'')" onkeyup="this.value=this.value.replace(/[^\d]/g,'')" type="text"/>
                    ...
                    <dl>
                        <dt>团购介绍：</dt>
                        <dd>
                            <textarea placeholder="请输入团购介绍" name="intro" rows="6" class="tarea w400"><?php echo $info['intro']; ?></textarea>
            ...
            <script type="text/javascript">
                ...
                function verifyForm(){
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo U('Seller/Promotion/groupbuyHandle'); ?>",
                        ...
                        success: function (data) {
                            if (data.status == 1) {
                                layer.msg(data.msg,{icon: 1,time: 1000})
                                    location.href = "<?php echo U('Seller/Promotion/group_buy_list'); ?>";
