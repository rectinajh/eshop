<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:47:"./application/admin/view2/user/account_log.html";i:1532661069;s:44:"./application/admin/view2/public/layout.html";i:1532661069;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
    ...
    <div class="flexigrid">
            ...
            <div class="hDivBox">
                <table cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <th align="center" axis="col6" class="">
                            <div style="text-align: center; width: 100px;" class="">用户积分</div>
                        </th>
                        <th align="center" axis="col6" class="">
                            <div style="text-align: center; width: 100px;" class="">提现币</div>
                        </th>
                        <th align="center" axis="col6" class="">
                            <div style="text-align: center; width: 100px;" class="">新淘链</div>
                        </th>   
                        <th align="center" axis="col6" class="">
                            <div style="text-align: center; width: 100px;" class="">奉献值</div>
                        </th>
                        <th align="center" axis="col6" class="">
                            <div style="text-align: center; width: 100px;" class="">算力</div>
                        </th>                       
        ...
        <div class="tDiv">
            <div class="tDiv2">
                <div class="fbutton">
                    <a href="<?php echo U('Admin/User/account_edit',array('uid'=>$user_id)); ?>">
                ...
                <table>
                    ...
                    <?php if(is_array($lists) || $lists instanceof \think\Collection || $lists instanceof \think\Paginator): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
                        <tr>
                            ...
                            <td align="left" class="">
                                <div style="text-align: center; width: 100px;"><?php echo $list['desc']; ?></div>
                            </td>
                            ...
                            <td align="center" class="">
                                <div style="text-align: center; width: 100px;">
                                    <?php if($list[withdraw_money] > 0): ?>+<?php endif; ?>
                                    <?php echo $list['withdraw_money']; ?>
                                </div>
                            </td>    
                            <td align="center" class="">
                                <div style="text-align: center; width: 100px;">
                                    <?php if($list[jin_num] > 0): ?>+<?php endif; ?>
                                    <?php echo $list['jin_num']; ?>
                                </div>
                            </td> 
                            <td align="center" class="">
                                <div style="text-align: center; width: 100px;">
                                    <?php if($list[dedication_money] > 0): ?>+<?php endif; ?>
                                    <?php echo $list['dedication_money']; ?>
                                </div>
                            </td>   
                            <td align="center" class="">
                                <div style="text-align: center; width: 100px;">
                                    <?php if($list[consume_cp] > 0): ?>+<?php endif; ?>
                                    <?php echo $list['consume_cp']; ?>
                                </div>
                            </td>                       
