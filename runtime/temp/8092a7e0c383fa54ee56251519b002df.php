<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:53:"./application/admin/view2/store/apply_class_list.html";i:1532661068;s:44:"./application/admin/view2/public/layout.html";i:1532661068;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
	...
	<div class="flexigrid">
		<div class="mDiv">
			<div class="ftitle">
				<h3>经营类目列表</h3>
				<h5>(共<?php echo count($bind_class); ?>条记录)</h5>
			</div>
				...
				<div class="sDiv">
					<div class="sDiv2" style="margin-right: 10px;border: none;">
						<select name="state" class="form-control">
							...
							<option value="0" <?php if(\think\Request::instance()->get('store_state') == '1'): ?>selected<?php endif; ?>>待审核</option>
							<option value="1" <?php if(\think\Request::instance()->get('store_state') == '2'): ?>selected<?php endif; ?>>已通过</option>
							<option value="2" <?php if(\think\Request::instance()->get('store_state') == '2'): ?>selected<?php endif; ?>>已拒绝</option>
						</select>
					</div>
					<div class="sDiv2">
