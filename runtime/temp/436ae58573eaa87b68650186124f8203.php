<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:47:"./application/admin/view2/web/settingFloor.html";i:1532661068;s:44:"./application/admin/view2/public/layout.html";i:1532661068;}*/ ?>
<!doctype html>
<html>
<head>
  ...
  <form id="web_form" method="post" name="form1">
    ...
    <div class="ncap-form-default">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <input type="text" value="<?php echo $web_config['web_sort']; ?>" name="web_sort" id="web_sort" class="input-txt">
          <span class="err"></span>
