			...
			<div class="tjhot-shoplist" id="ajax_hot_goods">
				...
				and g.is_on_sale = 1 and g.goods_state = 1 and g.goods_id IN ($filter_goods_id_str) order by g.sort DESC limit 5"); 
					...
					<div class="alone-shop">
                        ...
                        <div><p class="price-tag">商城价：<span class="li_xfo">￥</span><span><?php echo $hot['shop_price']; ?></span></p></div>
                        <!-- <?php if($hot['exchange_integral'] > 0): ?>
                        	<div><p class="price-tag">会员价：<span class="li_xfo">￥<span><?php echo $hot['shop_price']-$hot['exchange_integral']/$point_rate; ?>+<?php echo $hot['exchange_integral']; ?></span>积分</span></p></div>
                        <?php endif; ?>     -->
                       
						<p class="store-alone"><a href="<?php echo U('Home/Store/index',array('id'=>$hot['store_id'])); ?>"><?php echo $hot['store_name']; ?></a></p>
					</div>
				<?php endforeach; ?>
			</div>
			...
			<div class="tjhot-shoplist" id="ajax_sales_goods">
                ...
                g.is_on_sale = 1 and g.goods_state = 1 and g.goods_id IN ($filter_goods_id_str) order by g.sales_sum desc limit 5"); 
					...
					<div class="alone-shop">
                        ...
                        <div><p class="price-tag">商城价：<span class="li_xfo">￥</span><span><?php echo $sales['shop_price']; ?></span></p></div>
                        <!-- <?php if($sales['exchange_integral'] > 0): ?>
                        	<div><p class="price-tag">会员价：<span class="li_xfo">￥<span><?php echo $sales['shop_price']-$sales['exchange_integral']/$point_rate; ?>+<?php echo $sales['exchange_integral']; ?></span>积分</span></p></div>
                        <?php endif; ?> -->
                        
						<p class="store-alone"><a href="<?php echo U('Home/Store/index',array('id'=>$sales['store_id'])); ?>"><?php echo $sales['store_name']; ?></a></p>
					</div>
				<?php endforeach; ?>
			</div>
		</div>
						...
						<li>
							<div class="s_xsall">
								...
								<div class="price-tag">
                                    ...
                                    <div><span class="now">商城价：<em class="li_xfo">￥</em><em><?php echo $v[shop_price]; ?></em></span></div>
                                    <!-- <?php if($v['exchange_integral'] > 0): ?>
                                    	<div><span class="now">会员价：<em class="li_xfo">￥<?php echo $v['shop_price']-$v['exchange_integral']/$point_rate; ?>+<?php echo $v['exchange_integral']; ?>积分</em></span></div>
									<?php endif; ?> -->
								</div>
	...
	<div class="w1430">
		...
		<ul class="ul-li-column p" id="favourite_goods">
			<?php
                                ...
                                $md5_key = md5("select * from `__PREFIX__goods` where is_recommend = 1 and is_on_sale = 1 and goods_state = 1 order by sort DESC limit 5");
                                $result_name = $sql_result_favourite = S("sql_".$md5_key);
                                if(empty($sql_result_favourite))
                                {                            
                                    $result_name = $sql_result_favourite = \think\Db::query("select * from `__PREFIX__goods` where is_recommend = 1 and is_on_sale = 1 and goods_state = 1 order by sort DESC limit 5"); 
                                    S("sql_".$md5_key,$sql_result_favourite,31104000);
                                }    
                              foreach($sql_result_favourite as $key=>$favourite): ?>
				<li>
					<div class="pad">
						<a href="<?php echo U('Home/Goods/goodsInfo',array('id'=>$favourite[goods_id])); ?>">
							<img class="lazy" data-original="<?php echo goods_thum_images($favourite['goods_id'],238,200); ?>" style="display: inline;" />
						</a>
						<div class="shop_name2">
							<a href="<?php echo U('Home/Goods/goodsInfo',array('id'=>$favourite[goods_id])); ?>"><?php echo $favourite['goods_name']; ?></a>
						</div>
						<div class="price-tag">
                           
                            <div><span class="now">商城价：<em class="li_xfo">￥</em><em><?php echo $favourite[shop_price]; ?></em></span></div>
                            <!-- <?php if($favourite['exchange_integral'] > 0): ?>
                        	    <div><span class="now">会员价：<em class="li_xfo">￥<?php echo $favourite['shop_price']-$favourite['exchange_integral']/$point_rate; ?>+<?php echo $favourite['exchange_integral']; ?>积分</em></span></div>
							<?php endif; ?> -->
						</div>
					</div>
				</li>
