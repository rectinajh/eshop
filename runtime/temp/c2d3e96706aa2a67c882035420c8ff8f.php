<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:44:"./application/seller/new/report/saleTop.html";i:1532228866;s:41:"./application/seller/new/public/head.html";i:1532228866;s:41:"./application/seller/new/public/left.html";i:1532228866;s:41:"./application/seller/new/public/foot.html";i:1532228866;}*/ ?>
<!doctype html>
   ...
   <div id="sidebar" class="sidebar">
    ...
    <div id="layoutRight" class="ncsc-layout-right">
        ...
        <div class="main-content" id="mainContent">
            <div class="tabmenu">
                <ul class="tab pngFix">
                    <li class="active"><a href="<?php echo U('Seller/Report/saleTop'); ?>">销售排行</a></li>
                </ul>
            </div>
            <form method="post" id="search-form2" action="<?php echo U('Report/saleTop'); ?>" onsubmit="check_form();">
