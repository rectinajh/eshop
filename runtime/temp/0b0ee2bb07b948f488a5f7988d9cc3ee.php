<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:50:"./application/admin/view2/admin/supplier_info.html";i:1532661068;s:44:"./application/admin/view2/public/layout.html";i:1532661068;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
    ...
    <form class="form-horizontal" id="suppliersHandle" action="<?php echo U('Admin/supplierHandle'); ?>" method="post">
        ...
        <div class="ncap-form-default">
            <dl class="row">
                ...
                <dd class="opt">
                    <input type="text" name="suppliers_name" value="<?php echo $info['suppliers_name']; ?>" id="suppliers_name" class="input-txt">
                    <span class="err"></span>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input type="text" name="suppliers_desc" value="<?php echo $info['suppliers_desc']; ?>" id="suppliers_desc" class="input-txt">
                    <span class="err"></span>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input type="text" name="suppliers_contacts" value="<?php echo $info['suppliers_contacts']; ?>" id="suppliers_contacts" class="input-txt">
                    <span class="err"></span>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input type="text" name="suppliers_phone" value="<?php echo $info['suppliers_phone']; ?>" id="suppliers_phone" class="input-txt">
                    <span class="err"></span>
            ...
            <dl class="row">
                <dt class="tit">
                    <label for="admin_id"><em>*</em>所属管理员</label>
                </dt>
                <dd class="opt">
                    <select name="admin_id" id="admin_id">
                        <?php if(is_array($admin) || $admin instanceof \think\Collection || $admin instanceof \think\Paginator): $i = 0; $__LIST__ = $admin;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
                            <option value="<?php echo $item['admin_id']; ?>" <?php if($item[admin_id] == $info[admin_id]): ?> selected="selected"<?php endif; ?> ><?php echo $item['user_name']; ?></option>
