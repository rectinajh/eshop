<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:54:"./application/admin/view2/order/refund_order_info.html";i:1532661068;s:44:"./application/admin/view2/public/layout.html";i:1532661068;}*/ ?>
<!doctype html>
<html>
<head>
        ...
        <div class="contact-info">
          <h3>退款处理</h3>
             ...
             <dl class="row">
                 ...
                 <dd class="opt">
                     <label>已退款:<?php echo $order['order_amount']; ?></label>
                 </dd>
             </dl>
             <dl class="row">
		        <dt class="tit">
