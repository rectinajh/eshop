<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:42:"./application/admin/view2/order/print.html";i:1532228866;s:44:"./application/admin/view2/public/layout.html";i:1532228866;}*/ ?>
<!doctype html>
<html>
<head>
    ...
    <div class="ncap-order-details">
      ...
      <div class="tabs-panels">
        ...
        <div class="total-amount contact-info">
          <h3>订单总额：<strong style="color:#777">￥<?php echo $order['goods_price']; ?></strong></h3>
        </div>
      </div>
  	</div>

	<div style="width:1000px" no-print>
