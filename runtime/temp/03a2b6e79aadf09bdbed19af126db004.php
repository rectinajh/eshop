<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:49:"./application/seller/new/finance/withdrawals.html";i:1532228866;s:41:"./application/seller/new/public/head.html";i:1532228866;s:41:"./application/seller/new/public/left.html";i:1532228866;s:41:"./application/seller/new/public/foot.html";i:1532228866;}*/ ?>
<!doctype html>
    ...
    <div id="layoutRight" class="ncsc-layout-right">
        ...
        <div class="main-content" id="mainContent">
            ...
            <table class="search-form">
                <form method="get" action="<?php echo U('Finance/withdrawals'); ?>" id="search-form2" onsubmit="check_form();">
                    ...
                    <tr>
                        ...
                        <td class="w100">
                            <select id="status" name="status" class="w90">
                                ...
                                <option value="-2" <?php if($_REQUEST['status'] == -2): ?>selected<?php endif; ?>>已作废</option>
            ...
            <table class="ncsc-default-table">
                ...
                <?php if(count($list) > 0): if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                    <tr class="bd-line">
                        ...
                        <td>
                            <?php if($v[status] == 0): ?>申请中<?php endif; if($v[status] == 1): ?>审核成功<?php endif; if($v[status] == -1): ?>审核失败<?php endif; if($v[status] == -2): ?>已作废<?php endif; if($v[status] == 2): ?>已转账<?php endif; ?>
                        </td>
