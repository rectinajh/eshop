<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:41:"./application/admin/view2/user/index.html";i:1532661069;s:44:"./application/admin/view2/public/layout.html";i:1532661069;}*/ ?>
<!doctype html>
<html>
<head>
    ...
    <div class="flexigrid">
                ...
                <table cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <th align="center" abbr="total_amount" axis="col6" class="">
                            <div style="text-align: center; width: 60px;" class="">累计消费</div>
                        </th>
                        <th align="center" abbr="total_amount" axis="col6" class="">
                            <div style="text-align: center; width: 60px;" class="">团队业绩</div>
                        </th>
                        <th align="center" abbr="email" axis="col6" class="">
                            <div style="text-align: center; width: 120px;" class="">邮件地址</div>
                        </th>
                        ...
                        <th align="center" abbr="user_money" axis="col6" class="">
                            <div style="text-align: center; width: 50px;" class="">余额</div>
                        </th>
                        ...
                        <th align="center" axis="col6" class="">
                            <div style="text-align: center; width: 50px;" class="">提现币</div>
                        </th>
                        <th align="center" axis="col6" class="">
                            <div style="text-align: center; width: 50px;" class="">新淘链</div>
                        </th>
                        <th align="center" axis="col6" class="">
                            <div style="text-align: center; width: 50px;" class="">奉献值</div>
                        </th>
                        <th align="center" axis="col6" class="">
                            <div style="text-align: center; width: 50px;" class="">算力</div>
                        </th>
        ...
        <div class="tDiv">
            <div class="tDiv2">
                ...
                <div class="fbutton">
                    <a href="<?php echo U('User/add_Importuser'); ?>">
                        <div class="add" title="导入会员">
                            <span><i class="fa fa-plus"></i>导入会员</span>
                        </div>
                    </a>
                </div>
                <div class="fbutton">
