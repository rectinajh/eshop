<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:47:"./application/admin/view2/lottery/activity.html";i:1532661068;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
...
<script>
    var id = parseInt("<?php echo \think\Request::instance()->param('id'); ?>");
    id  = isNaN(id) ? 0 : id;
