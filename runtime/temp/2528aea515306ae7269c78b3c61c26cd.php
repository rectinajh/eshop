<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:42:"./application/admin/view2/order/index.html";i:1532661068;s:44:"./application/admin/view2/public/layout.html";i:1532661068;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
  ...
  <div class="flexigrid">
    <div class="mDiv">
      ...
      <div class="sDiv">
        <div class="sDiv2">
        	<input type="text" size="30" id="add_time_begin" name="add_time_begin" value="<?php echo $add_time_begin; ?>" class="qsbox"  placeholder="下单开始时间">
        </div>
        <div class="sDiv2">
        	<input type="text" size="30" id="add_time_end" name="add_time_end" value="<?php echo $add_time_end; ?>" class="qsbox"  placeholder="下单结束时间">
        </div>
        <div class="sDiv2">	 
        ...
        <table cellspacing="0" cellpadding="0">
          <thead>
	        	<tr>
	              ...
	              </th>				  <th align="left" abbr="order_sn" axis="col3" class="">	                <div style="text-align: left; width: 130px;" class="">会员账号</div>	              </th>	
