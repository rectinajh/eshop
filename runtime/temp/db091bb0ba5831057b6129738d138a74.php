<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:58:"./application/seller/new/plugin/shipping_list_default.html";i:1532228866;s:41:"./application/seller/new/public/head.html";i:1532228866;s:41:"./application/seller/new/public/left.html";i:1532228866;s:41:"./application/seller/new/public/foot.html";i:1532228866;}*/ ?>
<!doctype html>
            ...
            <div class="ncsc-form-default">
                <form method="post" id="addEditBrandForm">
                    ...
                    <dl>
                        ...
                        <dd>
                            <input class="w400 text" readonly type="text" value="<?php echo $setting['shipping_area_name']; ?>" name="shipping_area_name"/>
                    ...
                    <dl>
                        <dt>
                            ...
                            <select name="config[first_weight]">
                                <?php $__FOR_START_596231870__=500;$__FOR_END_596231870__=8000;for($v=$__FOR_START_596231870__;$v < $__FOR_END_596231870__;$v+=500){ ?>
                        ...
                        <dd>
                            <input class="w400 text" type="text" value="<?php echo $setting['config']['money']; ?>" name="config[money]" maxlength="30" onkeyup="this.value=this.value.replace(/[^\d.]/g,'')" onpaste="this.value=this.value.replace(/[^\d.]/g,'')"/>
                            <p class="hint">单位：元</p>
                        </dd>
                    </dl>
                    <dl>
                        <dt>
                            ...
                            <select name="config[second_weight]">
                                <?php $__FOR_START_1287710850__=500;$__FOR_END_1287710850__=8000;for($v=$__FOR_START_1287710850__;$v < $__FOR_END_1287710850__;$v+=500){ ?>
                        ...
                        <dd>
                            <input class="w400 text" type="text" value="<?php echo $setting['config']['add_money']; ?>" name="config[add_money]" maxlength="30" onkeyup="this.value=this.value.replace(/[^\d.]/g,'')" onpaste="this.value=this.value.replace(/[^\d.]/g,'')"/>
                            <p class="hint">单位：元</p>
                        </dd>
                    </dl>
