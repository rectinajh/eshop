<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:47:"./template/mobile/default/order/order_list.html";i:1532661070;s:44:"./template/mobile/default/public/header.html";i:1532661070;s:48:"./template/mobile/default/public/header_nav.html";i:1532661070;}*/ ?>
<!DOCTYPE html>
...
<head>
    ...
    <title>我的订单--<?php echo $tpshop_config['shop_info_store_title']; ?> - www.ohbbs.cn 欧皇源码论坛 </title>
                ...
                <div class="mypackeg ma-to-20 getmore">
                                ...
                                <div class="sc_list se_sclist paycloseto">
                                    ...
                                    <div class="deleshow fr">
                                        ...
                                        <div class="prices  wiconfine">
                                        	<?php if($order['cat_id1']==1066): ?>
                                        		<p class="sc_pri"><span>￥</span><span><?php echo $good[member_goods_price]; ?>+<?php echo $order[hcredit]; ?>红积分</span></p>
                                        	<?php else: ?>
                    ...
                    <div class="shop-rebuy-price p">
                        <div class="maleri30">
                            ...
                            <?php endif; if($order['order_button'][receive_btn] == 1): if($order['cat_id1']!=851): ?>	
                                <a class="shop-rebuy paysoon"  onclick="order_confirm(<?php echo $order['order_id']; ?>)">确认收货</a>
                              <?php else: ?>
                                <a class="shop-rebuy paysoon"  onclick="order_confirm(<?php echo $order['order_id']; ?>)">确认收货</a>
                                <a class="shop-rebuy paysoon"  onclick="order_notconfirm(<?php echo $order['order_id']; ?>)">不满意</a>
                              <?php endif; endif; if($order['order_button'][comment_btn] == 1): ?>
                                <a class="shop-rebuy" href="<?php echo U('Mobile/Order/comment'); ?>">评价晒单</a>
