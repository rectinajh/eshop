<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:44:"./application/admin/view2/tools/restore.html";i:1532661068;s:44:"./application/admin/view2/public/layout.html";i:1532661068;}*/ ?>
<!doctype html>
<html>
<head>
						...
						<tr data-id="<?php echo $vo['name']; ?>">
							...
							<td align="center" class="handle">
								<div style="text-align: center; width: 170px; max-width:170px;">
									<a href="<?php echo U('import?time='.$vo['time']); ?>" class="btn blue db-import"><i class="fa fa-repeat"></i>恢复</a>
