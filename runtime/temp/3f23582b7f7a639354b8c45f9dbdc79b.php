<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:43:"./application/admin/view2/order/detail.html";i:1532529446;s:44:"./application/admin/view2/public/layout.html";i:1532529446;}*/ ?>
<!doctype html>
<html>
<head>
        ...
        <div class="goods-info">
          ...
          <table>
            ...
            <?php if(is_array($action_log) || $action_log instanceof \think\Collection || $action_log instanceof \think\Paginator): $i = 0; $__LIST__ = $action_log;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$log): $mod = ($i % 2 );++$i;?>
	           	<tr>
	                 <td class="text-center"><?php echo $users[$log[action_user]]; ?></td>
