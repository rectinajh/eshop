<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:48:"./application/seller/new/coupon/coupon_info.html";i:1531930932;s:41:"./application/seller/new/public/head.html";i:1531930932;s:41:"./application/seller/new/public/left.html";i:1531930932;s:41:"./application/seller/new/public/foot.html";i:1531930932;}*/ ?>
<!doctype html>
            ...
            <div class="ncsc-form-default">
                <form id="handleposition" onsubmit="return false;">
                    ...
                    <dl>
                        ...
                        <dd>
                            <input id="condition" name="condition" value="<?php echo $coupon['condition']; ?>"  onpaste="this.value=this.value.replace(/[^\d.]/g,'')" onkeyup="this.value=this.value.replace(/[^\d.]/g,'')" type="text" class="text w130"/>
