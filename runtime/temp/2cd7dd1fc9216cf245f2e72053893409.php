<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:51:"./template/mobile/default/index/ajaxStreetList.html";i:1532661070;}*/ ?>
<?php if(is_array($store_list) || $store_list instanceof \think\Collection || $store_list instanceof \think\Paginator): $i = 0; $__LIST__ = $store_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$store): $mod = ($i % 2 );++$i;?>       
        <div class="dis-box p">
            <div class="g-s-i-img fl">
            	<a href="<?php echo U('Store/index',array('store_id'=>$store[store_id])); ?>"><img src="<?php echo $store['store_logo']; ?>"></a>
            </div>
            <div class="g-s-i-title fl">
                <h3 class="ellipsis-one"><?php echo $store['store_name']; ?></h3>
                <p class="t-remark m-top04">已经有 <span class="num1"><?php echo $store['store_collect']; ?></span>人关注</p>
