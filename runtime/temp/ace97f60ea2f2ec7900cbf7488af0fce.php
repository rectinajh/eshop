<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:53:"./application/seller/new/finance/order_no_statis.html";i:1532661069;s:41:"./application/seller/new/public/head.html";i:1532661069;s:41:"./application/seller/new/public/left.html";i:1532661069;s:41:"./application/seller/new/public/foot.html";i:1532661069;}*/ ?>
<!doctype html>
   ...
   <div id="sidebar" class="sidebar">
    ...
    <div id="layoutRight" class="ncsc-layout-right">
        ...
        <div class="main-content" id="mainContent">
            <div class="tabmenu">
                <ul class="tab pngFix">
                    <li class="active"><a href="<?php echo U('Finance/order_no_statis'); ?>">结算记录</a></li>
                </ul>
            </div>
            <table class="search-form">
                <form method="get" action="<?php echo U('Finance/order_no_statis'); ?>" id="search-form2" onsubmit="check_form();">
                    <input type="hidden" id="create_date" value="<?php echo $create_date; ?>" name="create_date">
                    <tr>
                        <td>&nbsp;</td>
            ...
            <table class="ncsc-default-table">
                ...
                <?php if(count($list) > 0): if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                    <tr class="bd-line">
                        ...
                        <td style="padding: 0 10px"><?php echo $v['order_sn']; ?></td>
                        <td><?php if($v['shipping_time'] == 0): ?>未发货<?php else: ?><?php echo date("Y-m-d H:i",$v['shipping_time']); endif; ?></td>
