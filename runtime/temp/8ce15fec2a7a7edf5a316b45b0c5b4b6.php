<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:48:"./application/seller/new/finance/remittance.html";i:1532228866;s:41:"./application/seller/new/public/head.html";i:1532228866;s:41:"./application/seller/new/public/left.html";i:1532228866;s:41:"./application/seller/new/public/foot.html";i:1532228866;}*/ ?>
<!doctype html>
   ...
   <div id="sidebar" class="sidebar">
    ...
    <div id="layoutRight" class="ncsc-layout-right">
        ...
        <div class="main-content" id="mainContent">
            <div class="tabmenu">
                <ul class="tab pngFix">
                    <li class="active"><a href="<?php echo U('Finance/remittance'); ?>">汇款记录列表</a></li>
                </ul>
            </div>
            <table class="search-form">
                <form method="get" action="<?php echo U('Finance/remittance'); ?>" id="search-form2" onsubmit="check_form();">
            ...
            <table class="ncsc-default-table">
                ...
                <?php if(empty($list) || (($list instanceof \think\Collection || $list instanceof \think\Paginator ) && $list->isEmpty())): ?>
                    ...
                    <tr class="bd-line">
                        ...
                        <td><?php if($v[status] == 2): ?>已付款<?php else: ?>待付款<?php endif; ?></td>
                        <td><?php echo date("Y-m-d H:i:s",$v['create_time']); ?></td>
                        <td class="tl"><?php echo $v['remark']; ?></td>
                    </tr>
                <?php endforeach; endif; else: echo "" ;endif; endif; ?>
                </tbody>
                <tfoot>
                <tr>
                    <td colspan="20"><?php echo $show; ?></td>
                </tr>
                </tfoot>
            </table>
        </div>
