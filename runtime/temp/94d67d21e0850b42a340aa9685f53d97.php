<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:50:"./template/mobile/default/gold/wallet_address.html";i:1532661070;s:44:"./template/mobile/default/public/header.html";i:1532661070;s:48:"./template/mobile/default/public/header_nav.html";i:1532661070;s:44:"./template/mobile/default/public/footer.html";i:1532661070;}*/ ?>
<!DOCTYPE html>
...
<head>
    ...
    <title>钱包地址--<?php echo $tpshop_config['shop_info_store_title']; ?> - www.ohbbs.cn 欧皇源码论坛 </title>
...
<div class="wallet_code">
    <img src="__ROOT__<?php echo $pic; ?>" alt="">
</div>
<div class="code_key">
    <div>
        <span>我的公钥:</span>
        <p class="copy"><?php echo $pub_key; ?></p>
    </div>
    <div style="margin-top: 50px;">
        <span>我的私钥:</span>
        <p class="copy"><?php echo $pri_key; ?></p>
    </div>
</div>
<div class="notice" style="width:100%;margin-top: 30px;text-align: center;font-size:.512rem;display: none">
    温馨提示：轻点即可复制
 </div>
 <!--底部-start-->
...
<script>
    $(".copy").click(function(){
        BSL.CopyText($(this).html())
    })
    var userAgent = navigator.userAgent;
        if(userAgent.indexOf("bsl") > 0 ){
		$(".notice").show();
		}else{$(".notice").hide();}
</script>
 <!--底部-end-->
