<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:54:"./application/seller/new/promotion/group_buy_list.html";i:1532661068;s:41:"./application/seller/new/public/head.html";i:1532661068;s:41:"./application/seller/new/public/left.html";i:1532661068;s:41:"./application/seller/new/public/foot.html";i:1532661068;}*/ ?>
<!doctype html>
   ...
   <div id="sidebar" class="sidebar">
	...
	<div id="layoutRight" class="ncsc-layout-right">
		...
		<div class="main-content" id="mainContent">
			<div class="tabmenu">
				<ul class="tab pngFix">
					<li class="active"><a href="<?php echo U('Promotion/group_buy_list'); ?>">团购列表</a></li>
				</ul>
				<!--<a href="" style="right:100px" class="ncbtn ncbtn-mint" title="新增虚拟商品抢购"><i class="icon-plus-sign"></i>新增虚拟抢购</a>-->
				<a href="<?php echo U('Promotion/group_buy'); ?>" class="ncbtn ncbtn-mint" title="新增团购"><i class="icon-plus-sign"></i>新增团购</a>
			...
			<table class="ncsc-default-table">
			  ...
			  <?php else: ?> 
				...
				<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $k=>$vo): ?>
					<tr class="bd-line">
						<td></td>
						<td class="tl"><?php echo getSubstr($vo['title'],0,30); ?></td>
						...
						<td class="nscs-table-handle">
							<span><a data-goods-id="<?php echo $vo['goods_id']; ?>" data-item-id="<?php echo $vo[item_id]; ?>" class="btn-bluejeans jump"><i class="icon-search"></i><p>查看</p></a></span>
                                <span><a href="<?php echo U('Promotion/group_buy',array('act'=>'edit','id'=>$vo['id'])); ?>" class="btn-bluejeans"><i class="icon-edit"></i><p>编辑</p></a></span>
                                <span><a data-url="<?php echo U('Promotion/groupbuyHandle'); ?>" data-id="<?php echo $vo['id']; ?>" onclick="delfun(this)" class="btn-grapefruit"><i class="icon-trash"></i><p>删除</p></a></span>
						</td>
					</tr>
				<?php endforeach; endif; else: echo "" ;endif; ?>
				</tbody>
