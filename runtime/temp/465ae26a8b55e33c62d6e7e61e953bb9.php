<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:47:"./application/admin/view2/goods/stock_list.html";i:1532661068;s:44:"./application/admin/view2/public/layout.html";i:1532661068;}*/ ?>
<!doctype html>
<html>
<head>
                ...
                <table cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <th align="center" abbr="article_show" axis="col5" class="">
                            <div style="text-align: center; width: 80px;" class="">商品规格</div>
                        </th>
                        <th align="center" abbr="article_time" axis="col6" class="">
                            <div style="text-align: center; width: 100px;" class="">商家名称</div>
                        </th>
                        <th align="center" abbr="article_time" axis="col6" class="">
                ...
                <table>
                    ...
                    <?php if(is_array($stock_list) || $stock_list instanceof \think\Collection || $stock_list instanceof \think\Paginator): $i = 0; $__LIST__ = $stock_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                        <tr>
                            ...
                            <td align="center" class="">
                                <div style="text-align: center; width: 80px;"><?php echo $v['goods_spec']; ?></div>
                            </td>
                            <td align="center" class="">
                                <div style="text-align: center; width: 100px;"><?php echo $store[$v[store_id]]; ?></div>
                            </td>
                            <td align="center" class="">
                                <div style="text-align: center; width: 130px;"><?php echo (isset($v['order_sn']) && ($v['order_sn'] !== '')?$v['order_sn']:"N/A"); ?></div>
                            </td>
                            <td align="center" class="">
