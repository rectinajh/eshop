<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:41:"./application/seller/new/admin/login.html";i:1532661069;}*/ ?>
...
.ecsc-login-container .login-right {
    width: 304px;height: 396px; padding: 0 76px 0 50px;background: rgba(255,255,255,0.8);float: left;
}
