<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:44:"./application/admin/view2/index/welcome.html";i:1532661069;}*/ ?>
<html>
<head>
    ...
    <div class="content start_content">
        <div class="contentWarp">
            ...
            <div class="contentWarp_item clearfix">
                ...
                <div class="clear"></div>
                <div class="section_order_select"style="margin-top: 42px;">
                  <ul>
                    	 <li>
                            <a style="cursor: default;" href="#">
                                <i class="ice ice_f"></i>
                                <div class="t">订单总额</div>
                                <span class="number"><?php echo $count['money']; ?></span>
                            </a>
                        </li>
                        <li>
                            <a style="cursor: default;" href="<?php echo U('Finance/remittal'); ?>">
                                <i class="ice ice_f"></i>
                                <div class="t">超过600订单总额</div>
                                <span class="number"><?php echo $count['moremoney']; ?></span>
                            </a>
                        </li>
                         <li>
                            <a style="cursor: default;" href="#">
                                <i class="ice ice_f"></i>
                                <div class="t">月销售额</div>
                                <span class="number"><?php echo $count['yuemoney']; ?></span>
                            </a>
                        </li>
                    </ul> 
