<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:54:"./application/admin/view2/finance/editWithdrawals.html";i:1532661069;s:44:"./application/admin/view2/public/layout.html";i:1532661069;}*/ ?>
<!doctype html>
<html>
<head>
    ...
    <form class="form-horizontal" id="editForm" method="post">
        ...
        <div class="ncap-form-default">
            ...
            <dl class="row">
                ...
                <dd class="opt"><strong class="red"><?php echo $user['withdraw_money']; ?></strong>元</dd>
            </dl>
            <dl class="row">
                <dt class="tit">
                    <label>申请提现金额</label>
                </dt>
                <dd class="opt"><strong class="red"><?php echo $data['shen_money']; ?></strong>元</dd>
            </dl>
            <dl class="row">
                    <dt class="tit">
                        <label>申请提现手续费</label>
                    </dt>
                    <dd class="opt"><strong class="red"><?php echo $data['fee']; ?></strong>元</dd>
            </dl>
            <dl class="row">
                <dt class="tit">
                    <label>实际到账</label>
            ...
            <dl class="row">
                ...
                <dd class="opt"><?php echo $data['bank_card']; ?></dd>
            </dl>
            <dl class="row">
                <dt class="tit">
                    <label>提现账户开户名</label>
                </dt>
                <dd class="opt"><?php echo $data['realname']; ?></dd>
            </dl>
            <dl class="row">
                <dt class="tit">
                    <label>申请时间</label>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <?php if($data[status] == 0): ?>申请中<?php endif; if($data[status] == 1): ?>审核通过<?php endif; if($data[status] == -1): ?>申请失败<?php endif; if($data[status] == -2): ?>无效作废<?php endif; if($data[status] == 2): ?>已完成转账<?php endif; ?>    
                </dd>
            </dl>
            <dl class="row">
                <dt class="tit">
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    ...
                    2:管理员审核通过<br/>
                    3:进入财务待转款列表<br/>
                    4:管理员处理给用户转账(转帐时自动扣除用户平台余额 ) <br/>
                </dd>
            </dl>
            <div class="bot">
                <?php if(in_array($data[status],array(-1,0,1))): ?>
            ...
            success: function (data) {
                if(data.status == 1){
                    layer.alert(data.msg, {
                        ...
                        window.location.href="/index.php?m=Admin&c=Finance&a=withdrawals";
                    });
                }else{
