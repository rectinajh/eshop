<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:46:"./application/admin/view2/store/store_add.html";i:1532661068;s:44:"./application/admin/view2/public/layout.html";i:1532661068;}*/ ?>
<!doctype html>
<html>
<head>
		...
		<div class="ncap-form-default">
			...
			<!-- <dl class="row">
				...
				<dt class="tit">
					...
					<label for=""><em>*</em>平台服务费用比例</label>

				</dt>

				<dd class="opt">

					<input type="text" value="<?php echo $store['deduct']; ?>" id="deduct" name="deduct" class="input-txt" />%
