<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:52:"./application/admin/view2/store/store_info_edit.html";i:1532661068;s:44:"./application/admin/view2/public/layout.html";i:1532661068;}*/ ?>
<!doctype html>
<html>
<head>
		...
		<div class="ncap-form-default" id="tab_store">
			...
			<!-- <dl class="row">
				...
				<dt class="tit">
					...
					<label>平台服务费用比例</label>

				</dt>

				<dd class="opt">

					<input  class="input-txt" name="deduct" id="deduct" value="<?php echo $store['deduct']; ?>" type="text">%
			...
			<dl class="row">
				...
				<dd class="opt">
					<input type="text" name="store[store_sales]" value="<?php echo $store['store_sales']; ?>" class="input-txt">
					<span class="err"></span>
					<p class="notic">店铺的总销量</p>
				</dd>
			</dl>
			<dl class="row">
			...
			<table class="store-joinin" cellspacing="0" cellpadding="0" border="0">
				...
				<tr>
					...
					<td colspan="20">
						...
						<select onblur="get_city(this,<?php echo $apply[company_city]; ?>)" id="province" name="company_province">
						...
						<select onblur="get_area(this)" id="city" name="company_city">
			...
			<table class="store-joinin" cellspacing="0" cellpadding="0" border="0">
				...
				<tr>
					...
					<td colspan="20">
						...
						<select onblur="get_blank_city(this,<?php echo $apply[bank_city]; ?>)" name="bank_province" id="bank_province">
					...
					<td colspan="20">
						...
						<a href="<?php echo $apply['legal_identity_cert']; ?>" target="_blank">
							...
							<?php if($apply[legal_identity_cert] == ''): ?>
								...
								<img id="legal_identity_cert" src="__PUBLIC__/images/not_adv.jpg" height="120">
