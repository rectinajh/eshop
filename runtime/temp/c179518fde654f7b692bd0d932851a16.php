<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:50:"./application/admin/view2/service/return_list.html";i:1532661068;s:44:"./application/admin/view2/public/layout.html";i:1532661068;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
  ...
  <div id="explanation" class="explanation" style="color: rgb(44, 188, 163); background-color: rgb(237, 251, 248); width: 99%; height: 100%;">
    <div id="checkZoom" class="title"><i class="fa fa-lightbulb-o"></i>
     ...
     <ul>
      <li>买家提交申请，商家同意后，如果订单未发货，商家发货时按换货要求发，如果以发货，由买家与卖家协商快递费用，卖家收到买家换货商品确认之后再次发货</li>
    </ul>
  </div>
  <div class="flexigrid">
    <div class="mDiv">
          ...
          <thead>
	        	<tr>
	              ...
	              <th align="center" abbr="consignee" axis="col4" class="">
	                <div style="text-align: center;  width:60px;" class="">申请类型</div>
	              </th>
	              ...
	              <th align="center" abbr="" axis="col5" class="">
	                <div style="text-align: center; width: 50px;" class="">换货数量</div>
	              </th>
			...
			<?php else: if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
		  	<tr>
		        ...
		        <td align="center" abbr="consignee" axis="col4" class="">
		          ...
		          <?php if($vo[type] == 2): ?>换货<?php endif; if($vo[type] == 3): ?>维修<?php endif; ?></div>
		        </td>
