<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:55:"./application/admin/view2/finance/store_remittance.html";i:1532661069;s:44:"./application/admin/view2/public/layout.html";i:1532661069;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
    <div class="fixed-bar">
        <div class="item-title">
           ...
           <ul class="tab-base nc-row">
            	<li><a <?php if($status == 1): ?>class="current"<?php endif; ?> href="<?php echo U('Finance/store_remittance',array('status'=>1)); ?>"><span>待转账列表</span></a></li>
            	<li><a <?php if($status == 2): ?>class="current"<?php endif; ?> href="<?php echo U('Finance/store_remittance',array('status'=>2)); ?>"><span>已转账列表</span></a></li>
            </ul>
        </div>
    </div>
    <!-- 操作说明 -->
    ...
    <div class="flexigrid">
        <div class="mDiv">
            ...
            <form class="navbar-form form-inline" id="remittance-form" method="get" action="<?php echo U('store_remittance'); ?>" onsubmit="return check_form();">
                ...
                <div class="sDiv">
                    ...
                    <div class="sDiv2" style="margin-right: 10px;">
                        <input size="30" id="store_id" name="store_id" value="<?php echo \think\Request::instance()->request('store_id'); ?>" placeholder="店铺ID" class="qsbox" type="text">
                    </div>
                    <div class="sDiv2" style="margin-right: 10px;">
                        <input size="30" placeholder="收款账户名" value="<?php echo $_GET[realname]; ?>" name="realname" class="qsbox" type="text">
                    </div>
                    <div class="sDiv2">
        ...
        <form class="form-inline" id="transfer-form" method="get" action="<?php echo U('store_transfer'); ?>">
        <div class="tDiv">
            <div class="tDiv2">
                    ...
                    <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                        <tr>
                            ...
                            <td align="center" class="">
                                <div style="text-align: center; width: 50px;">
                                    <a class="open" href="<?php echo U('editStoreWithdrawals',array('id'=>$v[id])); ?>">
                            ...
                            <td align="center" class="">
                                <div style="text-align: center; width: 120px;"><?php echo $v['bank_name']; ?></div>
                            </td>
                            <td align="center" class="">
                                <div style="text-align: center; width: 120px;"><?php echo $v['bank_card']; ?></div>
                            </td>
                            <td align="center" class="">
                                <div style="text-align: center; width: 120px;"><?php echo $v['realname']; ?></div>
                            </td>
                            <td align="center" class="">
                            ...
                            <td align="center" class="">
                                <div style="text-align: center; width: 100px;">
									<?php if($v[status] == 1): ?>待转账<?php else: ?>已转账<?php endif; ?>
                                </div>
                            </td>
                            <td align="center" class="">
                            ...
                            <?php if($status == 1): ?>
			                	<td align="center" class="handle">
			                	    <div style="text-align: center; width: 170px; max-width:250px;">
                                    	<a href="<?php echo U('store_transfer',array('selected'=>$v['id'],'atype'=>'online')); ?>" class="btn blue"><i class="fa fa-hand-o-right"></i>在线转账</a>
                                		<a href="<?php echo U('store_transfer',array('selected'=>$v['id'],'atype'=>'hand')); ?>" class="btn blue"><i class="fa fa-hand-o-up"></i>手动转账</a>
                                	</div>
			                	</td>
			                <?php endif; ?>
