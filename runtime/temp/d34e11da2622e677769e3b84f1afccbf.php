<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:48:"./application/admin/view2/comment/ajaxindex.html";i:1532661068;}*/ ?>
<table>
 	<tbody>
        ...
        <td align="left" abbr="img" axis="col4" class="">
        	<div style="text-align: left; width: 150px;">
        			<ul class="evaluation-pic-list">
        				<?php 
                                if(!empty($list['img'])){
                                    $imgs = unserialize($list['img']);
                                    if($imgs){
                                        foreach ($imgs as $key => $val){
                                        echo "<li><a href=".$val."><img src=".$val."></a></li>";
                                        }
                                    }
                                }
