<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:56:"./application/admin/view2/promotion/prom_goods_list.html";i:1532661068;s:44:"./application/admin/view2/public/layout.html";i:1532661068;}*/ ?>
<!doctype html>
<html>
<head>
						...
						<tr>
							...
							<td align="left" class="handle">
								<div style="text-align: left; width: 170px; max-width:170px;">
									...
									<?php if($vo['status'] == 1): ?>
										<a class="btn red" onclick="changeStatus(0,'<?php echo $vo['id']; ?>','prom_goods',3)"><i class="fa fa-close"></i>取消</a>
									<?php endif; ?>
