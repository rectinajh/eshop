<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:46:"./application/admin/view2/goods/goodsList.html";i:1532661068;s:44:"./application/admin/view2/public/layout.html";i:1532661068;}*/ ?>
<!doctype html>
<html>
<head>
          ...
          <thead>
            ...
            <tr>
              ...
              <th align="left" abbr="ac_id" axis="col4" class="">
                ...
                <div style="text-align: left; width: 220px;" class="" onclick="sort('goods_name');">商品名称</div>
              ...
              <th align="center" abbr="article_time" axis="col6" class="">
                ...
                <div style="text-align: center; width: 165px;" class="" onclick="sort('cat_id');">分类</div>
              ...
              <th align="center" abbr="article_time" axis="col6" class="">
                ...
                <div style="text-align: center; width: 60px;" class="" onclick="sort('is_on_sale');">商品状态</div>
              ...
              <th align="center" abbr="article_time" axis="col6" class="">
                ...
                <div style="text-align: center; width: 100px;" class="">平台服务费用</div>

              </th>  
			<th align="center" abbr="article_time" axis="col6" class="">

                <div style="text-align: center; width: 100px;" class="">商品标签</div>
