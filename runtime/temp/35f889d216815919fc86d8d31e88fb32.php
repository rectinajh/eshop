<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:56:"./application/admin/view2/promotion/prom_order_list.html";i:1532661068;s:44:"./application/admin/view2/public/layout.html";i:1532661068;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
	...
	<div class="flexigrid">
		<div class="mDiv">
			...
			<form class="navbar-form form-inline" id="search-form" action="<?php echo U('Promotion/prom_order_list'); ?>" method="get" onsubmit="return check_form();">
				...
				<div class="sDiv">
					...
					<div class="sDiv2">
						<select name="status" class="select">
							...
							<option value="0" <?php if($_POST[status] === '0'): ?>selected<?php endif; ?>>已关闭</option>
						</select>
						...
						<tr>
							...
							<td align="center" class="">
								<div style="text-align: center; width: 80px;">
									<?php if($vo[recommend] == 1): ?>
										<span class="yes" onClick="changeTableVal('prom_order','id','<?php echo $vo['id']; ?>','recommend',this)" ><i class="fa fa-check-circle"></i>是</span>
										<?php else: ?>
										<span class="no" onClick="changeTableVal('prom_order','id','<?php echo $vo['id']; ?>','recommend',this)" ><i class="fa fa-ban"></i>否</span>
									<?php endif; ?>
								</div>
							</td>
							<td align="left" class="handle">
								<div style="text-align: left; width: 170px; max-width:170px;">
									<?php if($vo['status'] == 1): ?>
										<a class="btn red" onclick="changeStatus(0,'<?php echo $vo['id']; ?>','prom_order')"><i class="fa fa-close"></i>取消</a>
									<?php endif; ?>
									<a class="btn red" href="javascript:void(0)" data-url="<?php echo U('Promotion/ajax_prom_order_del'); ?>" data-id="<?php echo $vo['id']; ?>" onClick="delfun(this)"><i class="fa fa-trash-o"></i>删除</a>
								</div>
							</td>
