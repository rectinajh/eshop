<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:45:"./application/seller/new/index/store_msg.html";i:1532228866;s:41:"./application/seller/new/public/head.html";i:1532228866;s:41:"./application/seller/new/public/left.html";i:1532228866;s:41:"./application/seller/new/public/foot.html";i:1532228866;}*/ ?>
<!doctype html>
   ...
   <div id="sidebar" class="sidebar">
    ...
    <div id="layoutRight" class="ncsc-layout-right">
        ...
        <div class="main-content" id="mainContent">
            ...
            <form id="op" action="<?php echo U('index/store_msg_batch'); ?>" method="post">
                        ...
                        <?php if(is_array($msg_list) || $msg_list instanceof \think\Collection || $msg_list instanceof \think\Paginator): $i = 0; $__LIST__ = $msg_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
                            <tr class="store_msg_<?php echo $list[sm_id]; ?>">
                                ...
                                <td class="nscs-table-handle">
                                    <span>
                                        <a onclick="showMsg('content_<?php echo $list['sm_id']; ?>');" class="btn-bluejeans" href="javasript:;">
