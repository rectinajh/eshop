<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:42:"./application/admin/view2/system/smtp.html";i:1532661068;s:44:"./application/admin/view2/public/layout.html";i:1532661068;}*/ ?>
<!doctype html>
<html>
<head>
...
<div class="page">
    ...
    <form method="post" id="handlepost" enctype="multipart/form-data" name="handlepost" action="<?php echo U('System/handle'); ?>">
        ...
        <div class="ncap-form-default">
            ...
            <div class="bot"><a href="JavaScript:void(0);" class="ncap-btn-big ncap-btn-green" onclick="document.handlepost.submit()">确认提交</a></div>
        </div>
    </form>
</div>
