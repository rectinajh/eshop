<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:46:"./application/admin/view2/goods/_category.html";i:1532661068;s:44:"./application/admin/view2/public/layout.html";i:1532661068;}*/ ?>
<!doctype html>
<html>
<head>
  ...
  <form action="<?php echo U('Goods/addEditCategory'); ?>" method="post" class="form-horizontal" id="category_form">
    <div class="ncap-form-default">
      ...
      <dl class="row">
        ...
        <dd class="opt">
          <div>
            <select name="cat_id1" id="cat_id1" class="form-control" onblur="get_category(this.value,'cat_id2','0');spec_scroll(this);" style="width:250px;">
                <option value="0">所有分类</option>
                <?php if(is_array($cat_list) || $cat_list instanceof \think\Collection || $cat_list instanceof \think\Paginator): if( count($cat_list)==0 ) : echo "" ;else: foreach($cat_list as $key=>$v): ?>                                            
                    <option value="<?php echo $v['id']; ?>"><?php echo $v['name']; ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>                                            
            </select>                    
            <select name="cat_id2" id="cat_id2" class="form-control"  onblur="get_category(this.value,'cat_id3','0');"  style="width:250px;">
                <option value="0">请选择商品分类</option>
            </select>
