<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:50:"./application/seller/new/finance/order_statis.html";i:1532228866;s:41:"./application/seller/new/public/head.html";i:1532228866;s:41:"./application/seller/new/public/left.html";i:1532228866;s:41:"./application/seller/new/public/foot.html";i:1532228866;}*/ ?>
<!doctype html>
   ...
   <div id="sidebar" class="sidebar">
    ...
    <div id="layoutRight" class="ncsc-layout-right">
        ...
        <div class="main-content" id="mainContent">
            <div class="tabmenu">
                <ul class="tab pngFix">
                    <li class="active"><a href="<?php echo U('Finance/order_statis'); ?>">结算记录</a></li>
                </ul>
            </div>
            <table class="search-form">
                <form method="get" action="<?php echo U('Finance/order_statis'); ?>" id="search-form2" onsubmit="check_form();">
            ...
            <table class="ncsc-default-table">
                ...
                <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                    <tr class="bd-line">
                        <td><?php echo $v['id']; ?></td>
                        <td><?php echo date("Y-m-d H:i",$v['start_date']); ?></td>
                        ...
                        <td><a href="<?php echo U('Order/index',array('order_statis_id'=>$v['id'])); ?>">查看订单</a></td>
                    </tr>
                <?php endforeach; endif; else: echo "" ;endif; ?>
                </tbody>
                <tfoot>
