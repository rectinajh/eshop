<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:48:"./template/pc/rainbow/cart/header_cart_list.html";i:1532661070;}*/ ?>
...
<?php else: ?>
    ...
    <div class="mn-c-m oh" style="overflow: auto;">
        <?php if(is_array($cartList) || $cartList instanceof \think\Collection || $cartList instanceof \think\Paginator): if( count($cartList)==0 ) : echo "" ;else: foreach($cartList as $k=>$v): ?>
            <div id="cart_<?php echo $v['id']; ?>" class="mn-c-box J-sdb-cb js_cart_top" style="">
                    ...
                    <dd class="c-list">
                        <div class="c-prod"><!-- 临时屏蔽 -->
                            ...
                            <div class="c-item fixed  js_cart_pro_list">
                                <a href="javascript:void(0);" class="del js_delete" onclick="header_cart_del(<?php echo $v['id']; ?>),ajax_side_cart_list();"></a>
