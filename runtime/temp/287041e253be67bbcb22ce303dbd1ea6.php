<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:46:"./application/seller/new/goods/stock_list.html";i:1531910247;s:41:"./application/seller/new/public/head.html";i:1531910247;s:41:"./application/seller/new/public/left.html";i:1531910247;s:41:"./application/seller/new/public/foot.html";i:1531910247;}*/ ?>
<!doctype html>
   ...
   <div id="sidebar" class="sidebar">
    ...
    <div id="layoutRight" class="ncsc-layout-right">
        ...
        <div class="main-content" id="mainContent">
            <div class="tabmenu">
                <ul class="tab pngFix">
                    <li class="active"><a href="<?php echo U('Goods/brandList'); ?>">库存日志列表</a></li>
                </ul>
            </div>
            <form id="search-form2" method="post" action="">
                ...
                <table class="search-form">
                    <tr>
                        ...
                        <td class="w100"><input style="width: 90px;" class="text" type="text" placeholder="商品名称" value="<?php echo $_REQUEST[goods_name]; ?>" name="goods_name"/></td>
                        <th>开始时间</th>
                        <td class="w100">
                            <input type="text" style="width: 90px;" class="text w90" id="start_time" value="<?php echo $start_time; ?>" placeholder="记录开始时间"/>
                        </td>
                        <th>截止时间</th>
                        <td class="w100">
                            <input type="text" style="width: 90px;" class="text w90" id="end_time" value="<?php echo $end_time; ?>" placeholder="记录截止时间"/>
                        </td>
            ...
            <table class="ncsc-default-table">
			    ...
			    <?php else: if(is_array($stock_list) || $stock_list instanceof \think\Collection || $stock_list instanceof \think\Paginator): $i = 0; $__LIST__ = $stock_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                    <tr class="bd-line">
                        <td></td>
                        <td><?php echo $v['id']; ?></td>
                        <td><?php echo getSubstr($v['goods_name'],0,30); ?></td>
                        <td><?php echo $v['goods_spec']; ?></td>
                        <td><?php echo (isset($v['order_sn']) && ($v['order_sn'] !== '')?$v['order_sn']:"N/A"); ?></td>
                        <td><?php echo $v['stock']; ?></td>
                        <td><?php if(empty($v[order_sn]) || (($v[order_sn] instanceof \think\Collection || $v[order_sn] instanceof \think\Paginator ) && $v[order_sn]->isEmpty())): ?>货品库存<?php else: ?>商品库存<?php endif; ?></td>
                        <td><?php echo $v['muid']; ?></td>
