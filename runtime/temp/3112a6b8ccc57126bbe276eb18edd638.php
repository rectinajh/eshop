<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:43:"./application/admin/view2/report/index.html";i:1532661068;s:44:"./application/admin/view2/public/layout.html";i:1532661068;}*/ ?>
<!doctype html>
<html>
<head>
						...
						<tr>
							...
							<td align="center" class="handle">
								<div style="text-align: center; width: 170px; max-width:170px;">
									<a href="<?php echo U('Report/saleList',array('start_time'=>$vo['day'],'end_time'=>$vo['end'])); ?>" class="btn blue"><i class="fa fa-search"></i>查看订单列表</a>
								</div>
							</td>
