<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:42:"./application/seller/new/goods/_goods.html";i:1532661068;s:41:"./application/seller/new/public/head.html";i:1532661068;s:41:"./application/seller/new/public/left.html";i:1532661068;s:41:"./application/seller/new/public/foot.html";i:1532661068;}*/ ?>
<!doctype html>
                ...
                <form method="post" id="addEditGoodsForm" >
                    ...
                    <div class="ncsc-form-goods active" id="tab_tongyong">
                        ...
                        <dl>
                            ...
                            <dd id="gcategory"> <?php echo $goods_cat[2][name]; ?> &gt;<?php echo $goods_cat[1][name]; ?> &gt;<?php echo $goods_cat[0][name]; ?> <a class="ncbtn" href="<?php echo U('Seller/Goods/addStepOne',array('goods_id'=>$goodsInfo[goods_id])); ?>">编辑</a>
                        ...
                        <dl>
                            ...
                            <dd>
                                ...
                                <select name="store_cat_id1" id="store_cat_id1" onclick="get_store_category(this.value,'store_cat_id2','0');">
						...
						<!-- <dl>
                                ...
                                <dd>
                                    ...
                                    <p>
                                        ...
                                        <input type="text" value="<?php echo $goodsInfo['sales_sum']; ?>" name="sales_sum" onkeyup="this.value=this.value.replace(/\D/g,'')" onpaste="this.value=this.value.replace(/\D/g,'')" class="text">

                                    </p>

                                    <p class="hint">商城显示的虚拟数量</p>
                       ...
                       <!--  <dl>
                            ...
                            <dd>
                                ...
                                <p class="hint">购买商品赠送用户算力，积分比例1元:<?php echo $tpshop_config[shopping_point_rate]; ?>积分</p>
                           ...
                           <!-- <dl>
                                ...
                                <dd>
                                    ...
                                    <p>
                                        ...
                                        <input type="text" value="<?php echo $goodsInfo['goods_xianzhi']; ?>" name="goods_xianzhi" onkeyup="this.value=this.value.replace(/\D/g,'')" onpaste="this.value=this.value.replace(/\D/g,'')" class="text">

                                    </p>

                                    <p class="hint">全积分商品可被兑换多少,0则不能被兑换</p>
                           ...
                           <!-- <dl>
                                ...
                                <dd>
                                    ...
                                    <p>
                                        ...
                                        <input type="text" value="<?php echo $goodsInfo['member_xianzhi']; ?>" name="member_xianzhi" onkeyup="this.value=this.value.replace(/\D/g,'')" onpaste="this.value=this.value.replace(/\D/g,'')" class="text">

                                    </p>

                                    <p class="hint">全积分商品可被会员兑换多少,0则不能被兑换</p>
                                ...
                                <div class="ncsc-form-goods-pic">
									...
									<div class="container">
								        ...
								        <div class="clabackkj">
									      ...
									      <?php endforeach; endif; else: echo "" ;endif; if(count($goodsImages) < 5): $__FOR_START_962711343__=count($goodsImages);$__FOR_END_962711343__=5;for($i=$__FOR_START_962711343__;$i < $__FOR_END_962711343__;$i+=1){ ?>
...
//			data:{goods_id:goods_id,cat_id3:cat_id3},
    ...
    $(document).ready(function(){
    	...
    	$("#shop_price").blur(function(){  
			...
			$("#give_integral_hint").html("可赠送算力不能超过"+send_point);
		...
		$("#addEditGoodsForm").validate({
            ...
            submitHandler: function(form){   //表单提交句柄,为一回调函数，带一个参数：form
            	...
            	if(give_integral > send_point){
            		...
            		layer.alert("最多可赠送算力不能超过"+send_point , {icon:2, time:2000});
