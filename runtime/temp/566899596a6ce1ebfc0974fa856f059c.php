<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:50:"./application/admin/view2/goods/ajaxGoodsList.html";i:1532661068;}*/ ?>
<table>
       ...
       <?php if(empty($goodsList) || (($goodsList instanceof \think\Collection || $goodsList instanceof \think\Paginator ) && $goodsList->isEmpty())): ?>
           ...
           <?php else: if(is_array($goodsList) || $goodsList instanceof \think\Collection || $goodsList instanceof \think\Paginator): $i = 0; $__LIST__ = $goodsList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
              ...
              <tr>
                ...
                <td align="center" axis="col0">
                  ...
                  <div style="text-align: left; width: 220px;"><?php echo getSubstr($list['goods_name'],0,33); ?></div>
                ...
                <td align="center" axis="col0">
                  ...
                  <div style="text-align: center; width: 150px;"><?php echo $catList[$list[cat_id1]][name]; ?></div>
                ...
                <td align="center" axis="col0">
                  ...
                  <div style="text-align: center; width: 100px;"> <input type="text" name="deduct" onblur="changeTableVal('goods','goods_id','<?php echo $list['goods_id']; ?>','deduct',this)" id="deduct" size="6" value="<?php echo $list['deduct']; ?>">%</div>

                </td> 
                <!--商品标签  -->
                <td align="center" axis="col0">

                  <div style="text-align: center; width: 100px;"> <input type="text" name="goods_label" onblur="changeTableVal('goods','goods_id','<?php echo $list['goods_id']; ?>','goods_label',this)" id="goods_label" size="6" value="<?php echo $list['goods_label']; ?>"></div>
                ...
                <td align="center" axis="col0">
                  ...
                  <div style="text-align: center; width: 120px; max-width:120px;">
                  	...
                  	<?php if($list[goods_state] < 3): ?>

                  	<a class="btn red" href="javascript:void(0);" onKeyUp="this.value=this.value.replace(/[^\d]/g,'')" onclick="takeoff(this)" goods_id="<?php echo $list['goods_id']; ?>" goods_sn="<?php echo $list['goods_sn']; ?>" goods_name="<?php echo $list['goods_name']; ?>">
		...
		<script>
            ...
            //   $.ajax({
            //     type:'post',
            //     url:'<?php echo U("Goods/ajaxDeduct"); ?>'
