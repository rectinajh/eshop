<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:51:"./template/mobile/default/gold/dedication_list.html";i:1532661070;s:44:"./template/mobile/default/public/header.html";i:1532661070;s:48:"./template/mobile/default/public/header_nav.html";i:1532661070;s:44:"./template/mobile/default/public/footer.html";i:1532661070;}*/ ?>
<!DOCTYPE html>
...
<head>
    ...
    <title>奉献值明细--<?php echo $tpshop_config['shop_info_store_title']; ?> - www.ohbbs.cn 欧皇源码论坛 </title>
        ...
        <div class="head_acc ma-to-20">
            ...
            <ul>
                ...
                <li <?php if($type == 'all'): ?>class="red"<?php endif; ?>">
                    ...
                    <a href="<?php echo U('Gold/dedication_list',array('type'=>'all')); ?>"  data-list="1">全部</a>

                </li>

                <li <?php if($type == 'plus'): ?>class="red"<?php endif; ?>>

                    <a href="<?php echo U('Gold/dedication_list',array('type'=>'plus')); ?>"   data-list="2">增长</a>

                </li>

                <li  <?php if($type == 'minus'): ?>class="red"<?php endif; ?>>

                    <a href="<?php echo U('Gold/dedication_list',array('type'=>'minus')); ?>"  data-list="3">减少</a>
         ...
         <div class="allpion">
         	...
         	<ul><li>描述</li><li>奉献值</li><li>时间</li></ul>
                  ...
                  <div class="fll_acc">
                      ...
                      <ul>
                          ...
                          <li>
                              ...
                              <span>奉献值：</span><span class="red"><?php echo $v[dedication_money]; ?></span></li>
...
//    var record=$('.record').val();   //获取记录类型
...

    {
        ...
        $.ajax({
            ...
            url:"/index.php?m=Mobile&c=Gold&a=dedication_list&is_ajax=1&type=<?php echo $type; ?>&p="+page,//+tab,
