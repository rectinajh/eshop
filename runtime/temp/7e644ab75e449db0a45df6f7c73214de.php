<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:45:"./application/seller/new/goods/brandList.html";i:1531930932;s:41:"./application/seller/new/public/head.html";i:1531930932;s:41:"./application/seller/new/public/left.html";i:1531930932;s:41:"./application/seller/new/public/foot.html";i:1531930932;}*/ ?>
<!doctype html>
...
<div class="ncsc-layout wrapper">
   ...
   <div id="sidebar" class="sidebar">
    ...
    <div id="layoutRight" class="ncsc-layout-right">
        <div class="ncsc-path"><i class="icon-desktop"></i>商家管理中心<i class="icon-angle-right"></i>商品<i class="icon-angle-right"></i>品牌申请
        </div>
        <div class="main-content" id="mainContent">
            <div class="tabmenu">
                <ul class="tab pngFix">
                    <li class="active"><a href="<?php echo U('Goods/brandList'); ?>">品牌申请列表</a></li>
                </ul>
