<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:40:"./template/mobile/default/user/cash.html";i:1532661070;s:44:"./template/mobile/default/public/header.html";i:1532661070;s:44:"./template/mobile/default/public/footer.html";i:1532661070;}*/ ?>
<!DOCTYPE html>
...
<body class="g4">
    ...
    <div class="myhearder bankhearder">
        ...
        <div class="title-money-box">
            <div class="xiaofei">
                <div class="money-name">提现币(元)</div>
                <div class="money-value"><?php echo $withdraw_money; ?></div>
            </div>
        </div>
    ...
    <div class="floor-floor">
        <ul class="floor-items">
            <li><a href="<?php echo U('Mobile/User/withdrawals'); ?>">
                <div class="itlt">
                    <i class="iconfont icon-tixian" style="color: #f3b21d;font-size: .64rem"></i>
                    <span>提现</span>
                </div>
                <div class="itrt">
                    <i class="Mright"></i>
            ...
            <li><a href="<?php echo U('Mobile/User/withdrawals_list'); ?>">
                    <div class="itlt">
                        <i class="iconfont icon-mingxi" style="color: #f96369"></i>
                        <span>提现明细</span>
                    </div>
                    <div class="itrt">
                        <i class="Mright"></i>
