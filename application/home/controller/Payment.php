...
class Payment extends Base{
    ...
    public function notifyUrl(){            
     ...
     //error_log($user['is_usercenter'].$user['member_name'].$order['integral'].SITE_URL.'/index.php/Home/Payment/notifyUrl/pay_code/weixin', 3, "hehehe20180129.log");
    ...
    public function returnUrl(){
         ...
         {
             $order = M('order')->where("master_order_sn", $result['order_sn'])->find();

             $integral = M('order')->where("master_order_sn", $result['order_sn'])->sum('integral');
