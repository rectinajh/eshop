    ...
    'system' => array('name' => '平台', 'child' => array(
        array('name' => '设置', 'child' => array(
            ...
            array('name' => '首页管理', 'act' => 'floorList', 'op' => 'Web'),
                        //array('name'=>'频道管理','act'=>'channelList','op'=>'Web'),
        ...
        array('name' => '会员', 'child' => array(
            ...
            // array('name' => '会员角色', 'act' => 'role', 'op' => 'User'),
            array('name' => '充值记录', 'act' => 'recharge', 'op' => 'User'),
            array('name' => '会员日志', 'act' => 'member_log', 'op' => 'User'),
                        //array('name'=>'提现申请','act'=>'withdrawals','op'=>'User'),
                        //array('name'=>'婚恋会员','act'=>'hunlian','op'=>'User'),
        )),
        ...
        array('name' => '文章', 'child' => array(
            ...
            array('name' => '快讯列表', 'act' => 'tllist', 'op' => 'Tlflash'),
        )),
        array('name' => '权限', 'child' => array(
            ...
            array('name' => '管理员日志', 'act' => 'log', 'op' => 'Admin'),
                        //array('name' => '分公司列表', 'act'=>'pany', 'op'=>'Admin'),
                        //array('name' => '办事处列表', 'act'=>'service', 'op'=>'Admin'),	
    ...
    'shop' => array('name' => '商城', 'child' => array(
        ...
        array('name' => '订单', 'child' => array(
            array('name' => '订单列表', 'act' => 'index', 'op' => 'Order'),
                    //array('name' => '易物区订单列表', 'act'=>'yworder_list', 'op'=>'Order'),
        ...
        array('name' => '促销', 'child' => array(
            array('name' => '抢购管理', 'act' => 'flash_sale', 'op' => 'Promotion'),
          	array('name' => '认筹管理', 'act' => 'plan', 'op' => 'Recognize'),
            array('name' => '抽奖管理', 'act' => 'activity', 'op' => 'Lottery'),
            ...
            // array('name' => '婚恋','child' => array(
            // 		array('name' => '注册申请', 'act'=>'apply', 'op'=>'HunLian'),
            // 		array('name' => '正式会员列表', 'act'=>'user_list', 'op'=>'HunLian'),
            // )),
            /*
        ...
        array('name' => '运营', 'child' => array(
            ...
            array('name' => '提现币提现申请', 'act' => 'withdrawals', 'op' => 'Finance'),
           // array('name' => '积分提现申请', 'act' => 'jifen', 'op' => 'Finance'),
            array('name' => '会员转款列表', 'act' => 'remittance', 'op' => 'Finance'),
           // array('name' => '积分转账列表', 'act' => 'jifenlog', 'op' => 'Finance'),
           // array('name' => '积分返还列表', 'act' => 'remittal', 'op' => 'Finance'),
