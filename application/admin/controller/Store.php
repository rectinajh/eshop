...
class Store extends Base{
	...
	public function store_info_edit(){
		...
		if(IS_POST){
			...
			$store['province_id'] = $map['company_province'];

			$store['city_id'] = $map['company_city'];

			$store['district_id'] = $map['company_district'];
